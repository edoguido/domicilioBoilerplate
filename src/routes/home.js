		...
		return (
			<Fragment>
				...
				<div class="text-center w-full">
					<p class="mb-5">
						Developed with ❤️ by <a class="text-orange-500" href={process.env.PREACT_APP_DEV_LINK}>{process.env.PREACT_APP_DEV_NAME}</a>
					</p>
					<p class="mb-5">
						Progetto originale di <a class="text-orange-500" href={process.env.PREACT_APP_CREATOR_LINK}>{process.env.PREACT_APP_CREATOR_NAME}</a>
					</p>
